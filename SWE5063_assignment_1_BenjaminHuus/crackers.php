...
<body>
    ...
    <div style="padding:20px;" class="container my-5">
        ...
        <div class="col-lg-12 p-3 p-lg-5 pt-lg-3">
            <h1 class="blue-fade">Squawkers</h1>
            <p class="lead">This Line of crackers is made to be better suited for a parrot's diet. Most name brand crackers today are overloaded with salt and preservatives. While parrots shouldn't indulge in these treats too often, squawkers are definitely a healthier indulgance for your bird!</p>

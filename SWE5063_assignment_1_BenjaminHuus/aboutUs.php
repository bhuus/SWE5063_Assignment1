...
<body>
    ...
    <div style="padding:20px;" class="container my-5">
        ...
        <div class="col-lg-12 p-3 p-lg-5 pt-lg-3">
            <h1>Meet our team!</h1>
            <p class="lead">Cheap tweets put together a panel of exotic bird experts in order to create the highest quality nutrition for you birds. Your pet's health is important! and we're here to look out for you.</p>
    ...
    <div class="row align-items-md-stretch" style="padding:20px;">
        <div class="col-md-6">
            <div class="h-100 p-5 bg-light border rounded-3" style="background-image: url('./images/moreParrots.jpg');background-size:cover; background-repeat: no-repeat; min-height:500px; max-height:500;max-width:700px;background-position: center;">
            </div>
        </div>
        <div class="col-md-6">
            <div class="h-100 p-5 bg-light border rounded-3" style="background-image: url('./images/goober.jpg');background-size:cover; background-repeat: no-repeat; min-height:500px; max-height:500;max-width:700px;background-position: center;">
            </div>
        </div>
    </div>
